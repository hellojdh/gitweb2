...
var JumperBot = function () {
    ...
    var canvas = document.getElementById('swingbot'),
        ...
        scorePosY = 20,     // Position (y point) where score is to be displayed
    ...
    function gameOverMessage(){
       ...
       context.fillText("Please try again next time.", screenWidth / 2, (screenHeight / 2) + 50);
    }
        /**
    ...
    function populateScore () {
        ...
        context.fillText(currScore , scorePosX, scorePosY);
        context.font = "15px Arial";
        context.fillText("남은 거미줄:" , scorePosX+350, scorePosY);
        context.fillText(bullet.count , scorePosX+450, scorePosY);
    }

    function drawBackground(){
            var backgroundImage = new Image();
            backgroundImage.src = "back.png";
            context.drawImage(backgroundImage, 0, 0, screenWidth, screenHeight)
        }
    ...
    function gameLoop () {
        ...
        if ( !isGameOver() ) {
            ...
            if ( (bot.posY > canvas.height)|(bullet.count<0) ) {
    ...
    return {
        ...
        bindUI: function () {
            canvas.onclick = function ( ev ) {
                fireBullet( ev.clientX-60, ev.clientY-120 );
            }
        }
    };
}